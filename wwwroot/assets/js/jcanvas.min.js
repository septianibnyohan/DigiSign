...
(function(g, U, J) {
    ...
    function Ha(d) {
        var c, a, b = [], f = 1;
        "transparent" === d ? d = "rgba(0, 0, 0, 0)" : d.match(/^([a-z]+|#[0-9a-f]+)$/gi) && (a = Ia.head,
        c = a.style.color,
        a.style.color = d,
        d = g.css(a, "color"),
        a.style.color = c);
    ...
    function T(d, c, a) {
        ...
        if (a = a._args)
            ...
            e = a.eventX,
            h = a.eventY,
            0 !== b ? (a._eventX = e * M(-b) - h * P(-b),
            a._eventY = h * M(-b) + e * P(-b)) : (a._eventX = e,
            a._eventY = h),
            a._eventX /= c.scaleX,
            a._eventY /= c.scaleY,
    ...
    function La(d, c, a, b, f, e, h, g) {
        var p, v;
        b.arrowRadius && !a.closed && (v = $a(g - e, h - f),
        v -= E,
        d = a.strokeWidth * M(v),
        p = a.strokeWidth * P(v),
        a = h + b.arrowRadius * M(v + b.arrowAngle / 2),
        f = g + b.arrowRadius * P(v + b.arrowAngle / 2),
        e = h + b.arrowRadius * M(v - b.arrowAngle / 2),
        b = g + b.arrowRadius * P(v - b.arrowAngle / 2),
        c.moveTo(a - d, f - p),
        c.lineTo(h - d, g - p),
        c.lineTo(e - d, b - p),
        c.moveTo(h - d, g - p),
    ...
    function Na(d, c, a, b) {
        ...
        for (void 0 !== b.x1 && void 0 !== b.y1 && c.moveTo(b.x1 + a.x, b.y1 + a.y); ; )
            ...
            g = b["cx" + (f - 1)],
            p = b["cy" + (f - 1)],
            void 0 !== e && void 0 !== h && void 0 !== g && void 0 !== p)
                c.quadraticCurveTo(g + a.x, p + a.y, e + a.x, h + a.y),
                f += 1;
            else
                break;
        --f;
    ...
    function Oa(d, c, a, b) {
        ...
        for (void 0 !== b.x1 && void 0 !== b.y1 && c.moveTo(b.x1 + a.x, b.y1 + a.y); ; )
            ...
            z = b["cx" + (e + 1)],
            D = b["cy" + (e + 1)],
            void 0 !== h && void 0 !== g && void 0 !== p && void 0 !== v && void 0 !== z && void 0 !== D)
                c.bezierCurveTo(p + a.x, v + a.y, z + a.x, D + a.y, h + a.x, g + a.y),
                f += 1,
                e += 2;
            else
                break;
    ...
    function Sa(d, c) {
        var a = c.maxWidth, b = String(c.text).split("\n"), f = [], e, h, g, p, v;
        for (g = 0; g < b.length; g += 1) {
            p = b[g];
            v = p.split(" ");
            e = [];
            h = "";
            if (1 === v.length || d.measureText(p).width < a)
                e = [p];
            else {
                for (p = 0; p < v.length; p += 1)
                    d.measureText(h + v[p]).width > a && ("" !== h && e.push(h),
                    h = ""),
                    h += v[p],
                    p !== v.length - 1 && (h += " ");
                e.push(h)
    ...
    var Ia = U.document, Ta = U.Image, ab = U.getComputedStyle, ea = U.Math, wa = U.Number, ba = U.parseFloat, ma, Z = g.extend, ia = g.inArray, aa = function(d) {
        return Object.prototype.toString.call(d).slice(8, -1).toLowerCase()
    }, da = g.isFunction, Ga = g.isPlainObject, E = ea.PI, Xa = ea.round, bb = ea.abs, P = ea.sin, M = ea.cos, $a = ea.atan2, ua = U.Array.prototype.slice, cb = g.event.fix, X = {}, ca = {
        dataCache: {},
        propCache: {},
        imageCache: {}
    }, oa = {
    ...
    g.fn.setLayer = function(d, c) {
        ...
        for (b = 0; b < this.length; b += 1)
            ...
            e = g(this[b]).getLayer(d)) {
                ...
                ka(c);
                for (h in c)
                    c.hasOwnProperty(h) && (K = c[h],
                    p = aa(K),
                    "object" === p && Ga(K) ? (e[h] = Z({}, K),
                    ka(e[h])) : "array" === p ? e[h] = K.slice(0) : "string" === p ? 0 === K.indexOf("+=") ? e[h] += ba(K.substr(2)) : 0 === K.indexOf("-=") ? e[h] -= ba(K.substr(2)) : !isNaN(K) && va(K) && "text" !== h ? e[h] = ba(K) : e[h] = K : e[h] = K);
                Ca(a, f, e);
                Ea(a, f, e);
    ...
    g.fn.drawLayer = function(d) {
        ...
        for (c = 0; c < this.length; c += 1)
            b = g(this[c]),
            (a = L(this[c])) && (a = b.getLayer(d)) && a.visible && a._method && (a._next = null,
            a._method.call(b, a));
        return this
    }
    ;
    g.fn.drawLayers = function(d) {
        var c, a, b = d || {}, f, e, h, K, p, v, z, D;
        (K = b.index) || (K = 0);
        for (c = 0; c < this.length; c += 1)
            if (d = g(this[c]),
            a = L(this[c])) {
                ...
                for (h = K; h < a.length; h += 1)
                    ...
                    z = f,
                    e = h + 1,
                    z && z.visible && z._method && (z._next = e ? e : null,
                    z._method.call(v, z)),
                    f._masks = p.transforms.masks.slice(0),
                ...
                if (p.drag.layer) {
                    ...
                    if ("mousemove" === r || "touchmove" === r) {
                        if (l.dragging || (l.dragging = !0,
                        m.dragging = !0,
                        m.bringToFront && (t.splice(m.index, 1),
                        m.index = t.push(m)),
                        m._startX = m.x,
                        m._startY = m.y,
                        m._endX = m._eventX,
                        ...
                        O(B, e, m, "dragstart")),
                        l.dragging)
                            for (r = m._eventX - (m._endX - m._startX),
                            t = m._eventY - (m._endY - m._startY),
                            m.dx = r - m.x,
                            m.dy = t - m.y,
                            "y" !== m.restrictDragToAxis && (m.x = r),
                            "x" !== m.restrictDragToAxis && (m.y = t),
                            O(B, e, m, "drag"),
                            B = 0; B < x.length; B += 1)
                                if (r = x[B],
                                t = e.layer.groups[r],
                                m.groups && t)
                                    for (r = 0; r < t.length; r += 1)
                                        t[r] !== m && ("y" !== m.restrictDragToAxis && "y" !== t[r].restrictDragToAxis && (t[r].x += m.dx),
                                        "x" !== m.restrictDragToAxis && "x" !== t[r].restrictDragToAxis && (t[r].y += m.dy))
                    } else if ("mouseup" === r || "touchend" === r)
                        l.dragging && (m.dragging = !1,
                        l.dragging = !1,
                        O(B, e, m, "dragstop")),
                        e.drag = {}
                }
                e = p.lastIntersected;
                null === e || f === e || !e._hovered || e._fired || p.drag.dragging || (p.lastIntersected = null,
                e._fired = !0,
                e._hovered = !1,
                O(d, p, e, "mouseout"),
                d.css({
                ...
                f && (f[z] || X.mouseEvents[z] && (z = X.mouseEvents[z]),
                f._event && f.intersects && (p.lastIntersected = f,
                !(f.mouseover || f.mouseout || f.cursors) || p.drag.dragging || f._hovered || f._fired || (f._fired = !0,
                f._hovered = !0,
                O(d, p, f, "mouseover")),
                f._fired || (f._fired = !0,
                v.type = null,
                O(d, p, f, z)),
                !f.draggable || f.disableEvents || "mousedown" !== z && "touchstart" !== z || (p.drag.layer = f)));
                null !== f || p.drag.dragging || d.css({
                    cursor: p.cursor
                });
                h === a.length && (p.intersecting.length = 0,
                p.transforms = la(oa),
                p.savedTransforms.length = 0)
            }
        return this
    }
    ;
    ...
    g.fn.animateLayer = function() {
        ...
        var a, b, f, e = ua.call(arguments, 0), h, K;
        ...
        for (b = 0; b < this.length; b += 1)
            ...
            f = L(this[b]))
                f = H(this[b]),
                (h = a.getLayer(e[0])) && h._method !== g.fn.draw && (K = Z({}, e[1]),
                K = Va(this[b], h, K),
                Fa(K, !0),
                Fa(h),
                h.style = V.propsObj,
        ...
        for (h = 0; h < this.length; h += 1)
            if (g = L(this[h]))
                ...
                z = 0; z < p.count; z += 1) {
                    var D = g
                      , m = v;
                    0 === m.savedTransforms.length ? m.transforms = la(oa) : (D.restore(),
                    m.transforms = m.savedTransforms.pop())
                }
        return this
    }
    ;
    ...
    g.fn.drawRect = function p(g) {
        ...
        for (z = 0; z < this.length; z += 1)
            if (D = L(this[z]))
                m = new J(g),
                N(this[z], m, g, p),
                m.visible && (Q(this[z], D, m, m.width, m.height),
                R(this[z], D, m),
                D.beginPath(),
                m.width && m.height && (B = m.x - m.width / 2,
                r = m.y - m.height / 2,
                (x = bb(m.cornerRadius)) ? (t = m.x + m.width / 2,
                l = m.y + m.height / 2,
                0 > m.width && (F = B,
                B = t,
                t = F),
                ...
                D.moveTo(B + x, r),
                D.lineTo(t - x, r),
                D.arc(t - x, r + x, x, 3 * E / 2, 2 * E, !1),
                D.lineTo(t, l - x),
                D.arc(t - x, l - x, x, 0, E / 2, !1),
                D.lineTo(B + x, l),
                D.arc(B + x, l - x, x, E / 2, E, !1),
                D.lineTo(B, r + x),
                D.arc(B + x, r + x, x, E, 3 * E / 2, !1),
                m.closed = !0) : D.rect(B, r, m.width, m.height)),
                T(this[z], D, m),
                W(this[z], D, m));
        return this
    }
    ...
    g.fn.drawArc = function v(g) {
        ...
        for (D = 0; D < this.length; D += 1)
            if (m = L(this[D]))
                B = new J(g),
                N(this[D], B, g, v),
                B.visible && (Q(this[D], m, B, 2 * B.radius),
                R(this[D], m, B),
                m.beginPath(),
                Ka(this[D], m, B, B),
                T(this[D], m, B),
    ...
    g.fn.drawEllipse = function z(g) {
        ...
        for (m = 0; m < this.length; m += 1)
            if (B = L(this[m]))
                r = new J(g),
                N(this[m], r, g, z),
                r.visible && (Q(this[m], B, r, r.width, r.height),
                R(this[m], B, r),
                t = 4 / 3 * r.width,
                l = r.height,
                B.beginPath(),
                B.moveTo(r.x, r.y - l / 2),
                B.bezierCurveTo(r.x - t / 2, r.y - l / 2, r.x - t / 2, r.y + l / 2, r.x, r.y + l / 2),
                B.bezierCurveTo(r.x + t / 2, r.y + l / 2, r.x + t / 2, r.y - l / 2, r.x, r.y - l / 2),
                T(this[m], B, r),
                r.closed = !0,
                W(this[m], B, r));
            ...
            if (r = L(this[B]))
                ...
                t.visible) {
                    ...
                    for (k = 0; k < t.sides; k += 1)
                        ...
                        n = t.y + t.radius * P(l),
                        r.lineTo(A, n),
                        t.concavity && (A = t.x + (y + -y * t.concavity) * M(l + F),
                        n = t.y + (y + -y * t.concavity) * P(l + F),
                        r.lineTo(A, n)),
                        l += x;
                    T(this[B], r, t);
                    t.closed = !0;
    ...
    g.fn.drawSlice = function m(B) {
        ...
        for (r = 0; r < this.length; r += 1)
            ...
            t = L(this[r]))
                l = new J(B),
                N(this[r], l, B, m),
                l.visible && (Q(this[r], t, l, 2 * l.radius),
                R(this[r], t, l),
                l.start *= l._toRad,
                l.end *= l._toRad,
                l.start -= E / 2,
                ...
                l.start = Ja(l.start),
                l.end = Ja(l.end),
                l.end < l.start && (l.end += 2 * E),
                x = (l.start + l.end) / 2,
                F = l.radius * l.spread * M(x),
                x = l.radius * l.spread * P(x),
                l.x += F,
                l.y += x,
                t.beginPath(),
                t.arc(l.x, l.y, l.radius, l.start, l.end, l.ccw),
                t.lineTo(l.x, l.y),
                T(this[r], t, l),
                l.closed = !0,
                W(this[r], t, l));
            ...
            if (A = L(this[y]))
                ...
                n.visible) {
                    ...
                    for (k = 1; ; )
                        ...
                        void 0 !== w)
                            w = new J(w),
                            "line" === w.type ? Ma(this[y], A, n, w) : "quadratic" === w.type ? Na(this[y], A, n, w) : "bezier" === w.type ? Oa(this[y], A, n, w) : "vector" === w.type ? Ra(this[y], A, n, w) : "arc" === w.type && Ka(this[y], A, n, w),
                            k += 1;
                        else
                            break;
                    T(this[y], A, n);
        ...
        for (A = 0; A < this.length; A += 1)
            ...
            n = L(this[A]))
                ...
                k.visible) {
                    ...
                    if (k.radius)
                        for (G = ba(k.fontSize),
                        null === k.letterSpacing && (k.letterSpacing = G / 500),
                        w = 0; w < C.length; w += 1) {
                            n.save();
                            n.translate(k.x, k.y);
                            u = C[w];
                            k.flipArcText && (u = u.split(""),
                            u.reverse(),
                            u = u.join(""));
                            S = u.length;
                            ...
                            for (H = 0; H < S; H += 1)
                                I = u[H],
                                0 !== H && n.rotate(E * k.letterSpacing),
                                n.save(),
                                n.translate(0, -k.radius),
                                k.flipArcText && n.scale(-1, -1),
                                n.fillText(I, 0, 0),
                                "transparent" !== k.fillStyle && (n.shadowColor = "transparent"),
                                0 !== k.strokeWidth && n.strokeText(I, 0, 0),
                                n.restore();
                            k.radius -= G;
                        ...
                        for (w = 0; w < C.length; w += 1)
                            u = C[w],
                            S = k.y + w * k.height / C.length - (C.length - 1) * k.height / C.length / 2,
                            n.shadowColor = k.shadowColor,
                            n.fillText(u, G, S),
                            "transparent" !== k.fillStyle && (n.shadowColor = "transparent"),
                            0 !== k.strokeWidth && n.strokeText(u, G, S);
                    S = 0;
                    "top" === k.baseline ? S += k.height / 2 : "bottom" === k.baseline && (S -= k.height / 2);
                    k._event && (n.beginPath(),
                    n.rect(k.x - k.width / 2, k.y - k.height / 2 + S, k.width, k.height),
                    T(this[A], n, k),
                    n.closePath());
    ...
    g.fn.drawImage = function y(A) {
        function n(k, n, y, q, u) {
            return function() {
                ...
                Q(k, n, q, q.width, q.height),
                R(k, n, q),
                n.drawImage(I, q.sx - q.sWidth / 2, q.sy - q.sHeight / 2, q.sWidth, q.sHeight, q.x - q.width / 2, q.y - q.height / 2, q.width, q.height)) : (Q(k, n, q, q.width, q.height),
                R(k, n, q),
                n.drawImage(I, q.x - q.width / 2, q.y - q.height / 2, q.width, q.height));
                n.beginPath();
                ...
                q.layer && (u._masks = y.transforms.masks.slice(0),
                q._next && w.drawLayers({
                    clear: !1,
                    resetFire: !0,
                    index: q._next
                }))
        ...
        var k, w, C, u, G, S, I, E, M, P = ca.imageCache;
        for (w = 0; w < this.length; w += 1)
            ...
            C = L(this[w]))
                ...
                G = new J(A),
                S = N(this[w], G, A, y),
                G.visible && (M = G.source,
                E = M.getContext,
                M.src || E ? I = M : M && (P[M] && P[M].complete ? I = P[M] : (I = new Ta,
                M.match(/^data:/i) || (I.crossOrigin = G.crossOrigin),
                I.src = M,
                P[M] = I)),
                I && (I.complete || E ? n(k, C, u, G, S)() : (I.onload = n(k, C, u, G, S),
                I.src = I.src)));
        return this
    }
    ;
    g.fn.createPattern = function(y) {
        ...
        G.call(C, y),
        A()) : (y = G.getContext,
        G.src || y ? C = G : (C = new Ta,
        G.match(/^data:/i) || (C.crossOrigin = w.crossOrigin),
        C.src = G),
        C.complete || y ? A() : (C.onload = A,
        C.src = C.src))) : u = null;
        return u
    }
    ;
    g.fn.createGradient = function(g) {
        var A, n = [], k, w, C, u, G, H, I;
        g = new J(g);
        if (A = L(this[0])) {
            g.x1 = g.x1 || 0;
            g.y1 = g.y1 || 0;
    ...
    g.fn.getCanvasImage = function(g, n) {
        var k, w = null;
        0 !== this.length && (k = this[0],
        k.toDataURL && (void 0 === n && (n = 1),
        w = k.toDataURL("image/" + g, n)));
        return w
    }
    ;
    g.fn.detectPixelRatio = function(A) {
        ...
        for (k = 0; k < this.length; k += 1)
            ...
            w = L(n),
            E = H(this[k]),
            E.scaled || (C = U.devicePixelRatio || 1,
            u = w.webkitBackingStorePixelRatio || w.mozBackingStorePixelRatio || w.msBackingStorePixelRatio || w.oBackingStorePixelRatio || w.backingStorePixelRatio || 1,
            C /= u,
            1 !== C && (u = n.width,
            G = n.height,
            n.width = u * C,
